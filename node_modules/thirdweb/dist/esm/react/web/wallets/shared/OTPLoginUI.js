        ...
        return (_jsxs(Container, { fullHeight: true, flex: "column", animate: "fadein", children: [_jsx(Container, { p: "lg", children: _jsx(ModalHeader, { title: locale.signIn, onBack: goBack }) }), _jsx(Container, { expand: true, flex: "column", center: "y", children: _jsxs("form", { onSubmit: (e) => {
                            e.preventDefault();
                                    ...
                                    verify(otpInput);
                                            ...
                                            width: "100%",
                                        }, children: locale.emailLoginScreen.verify }) }, "btn-container")) }), _jsx(Spacer, { y: "xl" }), !isWideModal && _jsx(Line, {}), _jsxs(Container, { p: isWideModal ? undefined : "lg", gap: "xs", children: [accountStatus === "error" && (_jsx(Text, { size: "sm", center: true, color: "danger", children: locale.emailLoginScreen.failedToSendCode })), accountStatus === "sending" && (_jsxs(Container, { flex: "row", center: "both", gap: "xs", style: {
                                            textAlign: "center",
                                        }, children: [_jsx(Text, { size: "sm", children: locale.emailLoginScreen.sendingCode }), _jsx(Spinner, { size: "xs", color: "secondaryText" })] })), accountStatus !== "sending" && (_jsx(LinkButton, { onClick: sendEmailOrSms, type: "button", children: locale.emailLoginScreen.resendCode }))] })] }) })] }));
    }
    return null;
}
