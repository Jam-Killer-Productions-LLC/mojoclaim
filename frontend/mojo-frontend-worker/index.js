export default {
  async fetch(request, env) {
    ...
    if (path === "/styles.css") {
      ...
      if (!css) {
        console.error("styles.css not found in R2");
    ...
    if (path === "/thirdweb.js") {
      ...
      if (!js) {
        console.error("thirdweb.js not found in R2");
        return new Response("Not Found", { status: 404 });
      }
      console.log("Serving thirdweb.js");
    ...
    if (!html) {
      console.error("index.html not found in R2");
      return new Response("Not Found", { status: 404 });
    }
